...
typedef struct {
	...
	int			scan_time;	/* Mins since 0h, Jan 1 1980 */
	short			ssec;		/* scan time seconds, if available */
	char			source[9];	/* Source name */
...
typedef struct {
	...
	char			corel_vers;	/* Corel version used */
	int			procdate;	/* Creation date for this extent */
	int			scan_time;	/* Seconds since 0h, Jan 1 1980 */
...
/* The total length of this structure in bytes is 176 */
