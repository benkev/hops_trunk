...
Ignore the messages about missing files and directories.  The script
autogen.sh is provided for convenience to do this.  With an argument
it will also remove auto-generated files.
