...
/* Parse5A.h 
 * Revised:  2007 May 22, JAB */ 
//#ifndef PARSE5A 
//#define PARSE5A 
/* *** Special-situation variables *** */ 
#define BCOLD /* Cold start */ 
...
#define SDK7 /* Have SDK 7.x from Conduant? (else SDK 6.x) */ 
/* *** */ 
#endif /* MARK5DIR_ORIG */
...
#endif /* MARK5DIR_ORIG */
struct SDir_A { /* Directory of recorded scans, etc. */ 
...
#endif /* MARK5DIR_ORIG */
struct Vsn_O { /* VSN plus serial numbers, etc. */ 
